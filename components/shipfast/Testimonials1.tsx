...
const Testimonial = () => {
  return (
    <section
      className="relative bg-base-100 px-8 py-24 sm:py-32 overflow-hidden isolate"
      id="testimonials"
    >
      <div className="-z-10 absolute inset-0 opacity-20" />
      <div className="right-1/2 -z-10 absolute inset-y-0 bg-base-100 shadow-lg mr-16 sm:mr-28 lg:mr-0 xl:mr-16 ring-1 ring-base-content/10 skew-x-[-30deg] w-[200%] origin-bottom-left xl:origin-center" />
      <div className="mx-auto max-w-2xl lg:max-w-5xl">
        <figure className="mt-10">
          <div className="flex lg:flex-row flex-col items-center gap-12">
            <div className="relative bg-base-content/5 p-1.5 border border-base-content/5 rounded-xl sm:-rotate-1">
              <Image
                width={320}
                height={320}
                className="border-2 border-white/10 shadow-md rounded-lg max-w-[320px] md:max-w-[280px] lg:max-w-[320px] object-center"
            ...
            <div>
              <blockquote className="font-medium text-base-content text-xl sm:text-2xl leading-8 sm:leading-10">
              ...
              <figcaption className="flex justify-start items-center gap-5 mt-10">
