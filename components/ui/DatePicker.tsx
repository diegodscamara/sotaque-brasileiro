...
import { cx, focusInput, focusRing, hasErrorInput } from "@/libs/utils"
        ...
        return (
            <PopoverPrimitives.Trigger asChild>
                <button
                    ...
                    {...props}
                >
                    <RiCalendar2Fill className="text-primary shrink-0 size-5" />
                    <span className="flex-1 text-ellipsis text-gray-900 text-left dark:text-gray-50 whitespace-nowrap overflow-hidden">
                        {children ? (
                            children
                        ) : placeholder ? (
...
const PresetContainer = <TPreset extends Preset, TValue>({
    ...
    return (
        <ul className="flex sm:flex-col items-start gap-x-2">
    ...
    return (
        ...
        >
            ...
            <CalendarPopover align={align}>
                <div className="flex">
                    <div className="flex sm:flex-row flex-col sm:items-start">
                        {presets && presets.length > 0 && (
                            ...
                            >
                                <div className="sm:left-0 absolute sm:inset-0 px-2 sm:py-2 pr-2">
                                    <PresetContainer
                                        currentValue={date}
                                        presets={presets}
                        ...
                        <div>
                            ...
                            />
                            {showTimePicker && (
                                <div className="border-gray-200 dark:border-gray-800 p-3 border-t">
                                    <TimeInput
                                        aria-label="Time"
                            ...
                            <div className="flex items-center gap-x-2 border-gray-200 dark:border-gray-800 p-3 border-t">
                                <Button
                                    variant="secondary"
...
const RangeDatePicker = ({
    ...
    return (
        ...
        >
            ...
            <CalendarPopover align={align}>
                <div className="flex">
                    <div className="flex sm:flex-row flex-col sm:items-start overflow-x-auto">
                        {presets && presets.length > 0 && (
                            <div
                                className={cx(
                            ...
                            >
                                <div className="sm:left-0 absolute sm:inset-0 px-3 sm:p-2">
                                    <PresetContainer
                                        currentValue={range}
                                        presets={presets}
                        ...
                        <div className="overflow-x-auto">
                            ...
                            />
                            {showTimePicker && (
                                <div className="flex justify-evenly items-center gap-x-3 border-gray-200 dark:border-gray-800 p-3 border-t">
                                    ...
                                    <RiSubtractFill className="text-gray-400 shrink-0 size-4" />
                                    <div className="flex flex-1 items-center gap-x-2">
                                        <span className="text-gray-700 dark:text-gray-30">
                            ...
                            <div className="sm:flex sm:justify-between sm:items-center border-gray-200 dark:border-gray-800 p-3 border-t">
