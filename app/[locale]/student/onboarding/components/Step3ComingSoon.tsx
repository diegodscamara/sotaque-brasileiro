...
/**
 * Step 3 of the onboarding process - Coming Soon placeholder
 */
export default function Step3ComingSoon(): React.JSX.Element {
  ...
  return (
    ...
    >
      {/* Step Title */}
      <div className="mb-6">
        <div className="mb-1 font-medium text-emerald-600 text-sm">{t("step3.step")}</div>
      ...
      <div className="bg-white dark:bg-gray-800 mb-8 p-8 border border-gray-200 dark:border-gray-700 rounded-lg">
        <div className="flex flex-col justify-center items-center py-12 text-center">
          <Rocket className="mb-4 w-12 h-12 text-emerald-600" weight="duotone" />
