...
export default function SignIn() {
  ...
  return (
    <section className="relative flex flex-col justify-center items-center gap-6 mx-auto px-4 py-20 md:py-24 lg:pb-16 max-w-7xl h-full container">
      <header aria-label="Logo" aria-roledescription="Logo">
        {/* Logo */}
        <Link
      ...
      <footer className="flex flex-row flex-wrap justify-center items-center gap-1 font-normal text-gray-600 dark:text-gray-400 text-sm text-center leading-4" aria-label="Disclaimer" aria-roledescription="Disclaimer">
        <p>
          {t("disclaimer")}
        </p>
