...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        "bg-gray-300 dark:bg-gray-600 text-muted-foreground data-[state=active]:bg-primary dark:data-[state=active]:bg-primary data-[state=completed]:bg-primary dark:data-[state=completed]:bg-primary data-[state=active]:text-primary-foreground dark:data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground dark:data-[state=completed]:text-primary-foreground relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium",
        className,
      )}
      data-state={state}
      {...props}
    >
      {asChild ? (
        ...
        <>
          <span className="group-data-loading/step:opacity-0 group-data-[state=completed]/step:opacity-0 group-data-loading/step:scale-0 group-data-[state=completed]/step:scale-0 transition-all group-data-loading/step:transition-none">
            {step}
          </span>
          <CheckIcon
            className="absolute opacity-0 group-data-[state=completed]/step:opacity-100 scale-0 group-data-[state=completed]/step:scale-100 transition-all"
            size={16}
            aria-hidden="true"
          />
          {isLoading && (
